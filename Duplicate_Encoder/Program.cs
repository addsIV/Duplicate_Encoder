    ...
    internal class main
    {
            ...
            int[][] board = new int[][]
        {
          ...
          new int[] {3, 0, 0, 2, 8, 6, 1, 7, 9},
            ...
            TreeNode bst1 = new TreeNode(3);
            bst1.left = new TreeNode(1);
            bst1.left.left = new TreeNode(3);
            bst1.right = new TreeNode(4);
            bst1.right.left = new TreeNode(1);
            bst1.right.right = new TreeNode(5);
            ...
            while (true)
            {
                ...
                Console.WriteLine(instanceA.NumDecodings_hard(inputString));
            }
